...
// This implementation is copied from the bubbletea-overlay component by rmhubbert.
// https://github.com/rmhubbert/bubbletea-overlay/blob/main/composite.go
func Composite(fg, bg string, xPos, yPos lipgloss.Position, xOff, yOff int) string {
...
func offsets(fg, bg string, xPos, yPos lipgloss.Position, xOff, yOff int) (int, int) {
	var x, y int
	switch xPos {
